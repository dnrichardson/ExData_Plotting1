...
## Create the first plot, a histogram of Global Active Power
png("plot1.png", width = 480, height = 480)
par(bg = NA)
hist(myData$Global_active_power, main = paste("Global Active Power"), xlab = "Global Active Power (kilowatts)",
     col = "red")
dev.off()
